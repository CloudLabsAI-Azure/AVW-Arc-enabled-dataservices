...
1. Actually in the background the Hyperscale executor creates a separate query for each shard, runs them on the workers, and combines the result. 
   ...
   Run following query the **PostgreSQL EXPLAIN** to see the Query Plan details   
...
## Task 7: Create Log anaytics workspace to upload logs, metric and usages to Azure Monitor. 
