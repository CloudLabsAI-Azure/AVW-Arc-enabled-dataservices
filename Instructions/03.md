...
1. In the Deploy PostgreSQL Hyperscale server group - Azure Arc blade, enter the following information:
   ...
   **Under General settings**
   ...
   - **Port**: Leave it default
    ...
    > **Note**: By taking 2 worker nodes initially will help server group hold more data and use more CPU cores to runn the queries across distributed data efficiently right from the startup.
