# Exercise 3: Azure Arc enabled PostgreSQL Hyperscale [Read-Only]

> Note: There is an update going on for this exercise due to which you won't be able to complete the exercise succesfully. You can read through the tasks given below and move forward to the next exercise
