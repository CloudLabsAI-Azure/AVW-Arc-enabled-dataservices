...
You will verify if the database has been restored from the Database running on the source server to the Arc enabled PostgreSQL Server by querying the data in both databases.
