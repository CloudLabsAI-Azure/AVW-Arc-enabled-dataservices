...
You will take backup of the Postgres Server running on-premises on a bare metal server named **Postgres**. It hosts a database named **Arc-Demo-PG** that has 4 tables.
...
### Restore the database in your Arc enabled data services environment
