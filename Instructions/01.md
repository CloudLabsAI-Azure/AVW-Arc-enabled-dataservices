...
13. Click on the azure-arc-data-SUFFIX Resource group and confirm whether you have all the below resources deployed successfully.
   ...
   ![](images/rgnew.png "Resource groups")
   ...
   * **Kubernetes Services**: We have two AKS deployed here and we are using one for the Direct mode and second for the Indirect or disconnected mode. We have already deployed the Azure Arc Data controller on to the Kubernetes Service and in later exercises we will be deploying Azure arc enabled data resources on to the Kubernetes cluster using Azure Arc data services.
