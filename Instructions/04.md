...
1. Launch Azure Data Studio and click on the **localhost** to connect with the local server. After connecting Expand the databases folder and right-click on **AdventureWorks2019** Database, and select **New Query**.
