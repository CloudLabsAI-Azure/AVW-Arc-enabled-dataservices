...
1. Log into Azure Portal and go to your lab environment RG, you will be able to find Azure blob storage name as acrblobstorageSUFFIX, open that and click on the Access keys from the left side bar. Now click on the Containers button to get the keys.
