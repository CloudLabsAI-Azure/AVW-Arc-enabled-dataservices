...
1. Once the installation is complete, Right click on the Azure arc data controller and click on refresh to see the newly created Azure Arc enabled SQL Managed Instance.

1. Right click on the newly created SQLMI instance and click on manage button to see the dashboard and connection details.
