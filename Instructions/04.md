...
In this exercise, you will create an **Azure SQL managed instance - Azure Arc** and restore and migrate the database using multiple methods. Also you will be exploring the the Kibana and Grafana and upload the logs and usages to Azure portal and view the logs.

## Task 1: Create Azure Arc enabled SQL Managed Instance 

In this task, you will learn how to Create Azure Arc enabled SQL Managed Instance using Azure Arc Data controller.

1. Open **Azure data studio** from desktop if not already opened. 

1. Now right click on the Azure Arc data controller connection, click on Manage and then click on **New Instance** button from the Azure Arc Data controller dashboard. 
...
1. Now under servers you can see that you are successfully connected with your Azure Arc enabled SQL MI Server. You can explore the SQLMI dashboard to view the databases and run a query.
   ...
   Now you can see that you are successfully connected with your Azure Arc enabled SQL MI Server
