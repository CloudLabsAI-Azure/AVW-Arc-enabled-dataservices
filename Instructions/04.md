...
3. Launch Azure data studio and Click on the **localhost** to connect with local server, After connecting Expand the databases folder and right-click on **AdventureWorks2019** Database and select **New Query**.
...
6. Open the Azure portal and validate that the backup file created in the previous step is visible in the Blob container. for this you have to goto storage accoung and the click on the container button and then open arccontainer to view the backup file.
