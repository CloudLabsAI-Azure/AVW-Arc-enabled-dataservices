...
1. Now, to restore the AdventureWorks database, you can run the following command.
   ...
   > **Note**: Ensure to replace the value of the pod and the namespace name before you run it. Rest of the values we have already filled in the commands, you can go through the commands and figure out what all are being passed as arguements.
