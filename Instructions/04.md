...
1. From the next page, open the **azure-arc** resource group. You will be able to find a resource of type Azure blob storage with name as **arcstorage<injectkey="DeploymentID/Suffix" />**. Click on that resource. 
