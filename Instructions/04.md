...
In this exercise, you will create an **Azure SQL managed instance - Azure Arc** and restore and migrate the database using multiple methods. Also you will be exploring the the Kibana and Grafna and upload the logs and usages to Azure portal and view the logs.
