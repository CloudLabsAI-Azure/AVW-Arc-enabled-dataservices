...
1. On the LabVM provided to you, open a command prompt and run the following command to login to azure. On the sign in page enter the username and password, you can find the username and password from the environment details tab.
