...
1. You can scale your Azure Arc enabled PostgreSQL Hyperscale server group by adding worker nodes without downtime and by scaling compute vCores and memory
